            ...
            <div className="about-container">
                ...
                <div className="about-body" data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    <div className="content">
                        <p>
                            Founded in 2014 by doctor Anshul Singh, Shree Ram hospital has come a long way from its beginning. Shree Ram hospital has been awarded the National Accreditation Board for Hospitals and healthcare providers (NABH) certificate, a national level recognition for quality patient care and safety.
NABH is a constituent board of quality council of India, setup to establish and operate accreditation programme for healthcare organisations. The board is structured to set benchmarks for progress of health industry.
We therefore feel very humble, obliged and grateful to announce that we are now NABH accredited, first in the district and one of the pioneer in the division for providing a quality healthcare and valuable experience to the patient. Our healthcare offerings are supported by a team of compassionate and dedicated medical professionals who are well experienced in their respective domains.
